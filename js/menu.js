var menuState = {
    ...
    create: function(){
        ...
        var label = game.add.text(game.world.centerX - 100,450,"Play",{font: '40px Arial', fill: '#FFFFFF'});
        
        var button1 = game.add.button(game.world.centerX +50 , 400, 'start', this.tutorial, this, 0,1,0);
        var label1 = game.add.text(game.world.centerX + 50,450,"Tutorial",{font: '40px Arial', fill: '#FFFFFF'});
